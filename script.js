...
function updatePlayerControlsVisibility(player) {
    ...
    const isOwnLeaderAbilityPassive = player.commander && player.commander.abilities && player.commander.abilities.includes('leader_cancel_opponent_ability');
    ...
    activateLeaderButton.disabled = !isPlayerTurn || 
                                (player.commander && player.commander.activatedThisRound) || 
